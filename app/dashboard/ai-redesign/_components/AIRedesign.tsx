				...
				{DesignTypes.map((design, index) => (
					...
					>
						...
						<Image
							...
							width={100}
							height={100}
							className={`rounded-md mb-3 hover:scale-150 hover:shadow-lg transition-all cursor-pointer ${
								design.name === selectedRoomRedesign &&
								"border-4 border-colors-custom-purple rounded-md "
							} `}
						/>
						<h3
							className={`font-semibold text-colors-custom-purple ${
								design.name === selectedRoomRedesign && "font-bold text-xl"
							}`}
						>
							{design.name}
						</h3>
